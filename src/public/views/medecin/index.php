            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="">
                            <a href="index.php"><i class="fas fa-user-graduate active"></i> <span>Medecin</span></a>
                        </li>
                    </ul>
                </div>
            </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="tel:<?php echo $medecin['tel'] ?>"><?php echo $medecin['tel'] ?>
                                                            <button type="submit"><i class="fas fa-phone"></i></button>
                                                        </form>
                                                    </td>
                                                    <td><?php echo $medecin['specialiteComplementaire'] ?></td>
                                                    ...
                                                    <td class="text-right">
                                                        <div class="actions">
                                                            ...
                                                            <a href="supprimer.php?id=<?php echo $medecin['id'] ?>" class="btn btn-sm bg-danger-light">
